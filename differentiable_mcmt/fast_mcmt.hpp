...
namespace GEO {
	...
	public:
        ...
        std::vector<double> lloyd_relaxation(double* point_positions, int num_points, int num_iter, double min_value, double max_value);
	...
	private:
		...
		std::vector<double> point_average_volume_;
		...
		void get_cell(index_t v, ConvexCell& C,  double min_value, double max_value);
